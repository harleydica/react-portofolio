...
// u can use import picture from your galeri sites
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-4 flex justify-between dark:text-white">
            <a href="#" className="font-burtons text-xl">Portofolio Sites</a>
          ...
          <div className="text-center p-10 py-1">
            ...
            <div className="text-4xl flex justify-center gap-4 py-3 text-gray-600 dark:text-gray-400">
              ...
              <a href="#"><AiFillYoutube size={40} /></a>
            </div>
          </div>
        </section>
        <section>
